...
| Bullet lists and decimal, letter, or roman lists, including nesting and a start value | Supported |
...
| Comments, footnotes, text boxes, equations, OLE objects, theme colors | Not supported |
